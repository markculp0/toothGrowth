...
The histogram of tooth odontoblast length for the guinea pigs given orange juice appears to have a positive slope, possibly due to increasing dosages.
...
Tooth growth appears to increase with dosage levels under both supplements but the difference between the two supplements is much more significant at the 0.5 and 1.0 mg/day levels than it is at the 2.0 mg/day level.  One concern here would be the increase in the variance of the ascorbic acid sample at the 2.0 dossage level.  One would expect it to decrease with an increased dossage level as the orange juice sample did.
